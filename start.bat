...
start "S-Anchor-Python" /MIN /D "%ROOT%python-core" cmd /c "%PY% -m uvicorn server:app --host 127.0.0.1 --port %PY_PORT% --log-level warning > \"%ROOT%python-core\server.log\" 2>&1"
